...
stockDataManager = StockPricesDataManager("stock")
...
results = mongoDataManager.get_items(collection, query)

companies = ['PEG', 'PSA', 'PHM', 'PVH', 'QRVO', 'PWR', 'QCOM']
results = stockDataManager.load_comps_data_btn_dates(collection, companies, start_date, end_date)
print(results)